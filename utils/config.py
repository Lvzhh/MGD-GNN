...
data_arg.add_argument('--gaz_file', type=str, default="/data/lzh/data/NeuralSegmentation/sgns.merge.word", help="lexical embeddings file")
data_arg.add_argument('--char_embedding_path', type=str, default="/data/lzh/data/NeuralSegmentation/gigaword_chn.all.a2b.uni.ite50.vec",help="characher embeddings file")
