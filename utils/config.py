...
net_arg.add_argument('--gat_layer', type=int, default=2, choices=[1, 2, 3, 4])
...
net_arg.add_argument('--pos_emb_dim', type=int, default=30, help="dim of position embedding")
...
data_arg.add_argument('--gaz_file', type=str, default="/data1/lzh/data/NeuralSegmentation/sgns.merge.word", help="lexical embeddings file")
data_arg.add_argument('--char_embedding_path', type=str, default="/data1/lzh/data/NeuralSegmentation/gigaword_chn.all.a2b.uni.ite50.vec",help="characher embeddings file")
data_arg.add_argument('--data_stored_directory', type=str, default="./logs/generated_data/")
data_arg.add_argument('--param_stored_directory', type=str, default="./logs/model_param/")
